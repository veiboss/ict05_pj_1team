			...
			<div id="container" class="container">
				...
				<main id="content">
					<div class="write-form box-wrap">
						<form action="drugAddAction.ad" onsubmit="return validateForm();">
							<fieldset>
								...
								<div class="row">
									<div class="field col">
										...
										<div class="insert">
											<input type="text" name="dr_product" id="dr_product" class="input-text medium" title="제약명" placeholder="예)올인원 멀티비타민 코어">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="field col">
										...
										<div class="insert">
											<input type="text" name="dr_enterprise" id="dr_enterprise" class="input-text medium" title="업체명" placeholder="예)주식회사 노바렉스">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="field col">
										...
										<div class="insert">
											<input type="text" name="dr_statement_id" id="dr_statement_id" class="input-text medium" title="품목번호" placeholder="예)200400200083249">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="field col">
										...
										<div class="insert">
											<input type="text" name="dr_expiration_date" id="dr_expiration_date" class="input-text medium" title="유통기한" placeholder="예)제조일로부터 24개월">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="field">
										...
										<div class="insert">
											<textarea class="textarea medium" rows="4" cols="50" name="dr_serve_use" placeholder="예) 1일 1회, 1회 1포(1포 : 칼마디정제 1100mg X 1T, 멀티비타민정제 1100mg X 1T, 루테인지아잔틴 연질캡슐 400mg X 1C, 오메가3 연질캡슐 760mg X 1C)를 물과 함께 섭취하십시오."></textarea>
										</div>
									</div>
								</div>
								<div class="row">
...
[비타민 K] 항응고제 등 복용 시 전문가와 상담할 것"></textarea>
										</div>
									</div>
								</div>
								<div class="row">
...
[비타민 D] 칼슘과 인이 흡수되고 이용되는데 필요, 뼈의 형성과 유지에 필요, 골다공증발생 위험 감소에 도움을 줌"></textarea>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="field">
										...
										<div class="insert">
											<textarea class="textarea medium" rows="4" cols="50" name="dr_preservation" placeholder="예)1. 고온다습한 곳과 직사광선을 피하여 습기가 적고 건조한 곳에 보관하십시오. 2. 개봉 후에는 공기의 노출을 최대한 차단하여 보관하십시오. 3. 영유아 및 어린이의 손에 닿지 않는 곳에 보관하십시오. 4. 온도 및 습도 등의 변화에 의해 캡슐이 붙는 현상이 발생될 수 있으나, 품질에 이상이 없으니 안심하고 섭취하십시오."></textarea>
										</div>
									</div>
								</div>
								<div class="row">
