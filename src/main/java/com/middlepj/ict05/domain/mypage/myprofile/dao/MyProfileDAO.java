...
//	public MyProfileDTO myProfile(String mbp_email);
//	
//	public MyProfileDTO myProfileEditAction(String mbp_email);
//	
//	public MyProfileDTO myProfileGradeAction(String mbp_email);	//이건 쓸지 모름
//	
